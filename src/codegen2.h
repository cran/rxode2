...
sAppend(&sbOut, "#define rxnbinom _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define rxnbinomMu _rx%s%s%ld\n", extra, md5, __timeId++);
...
sAppend(&sbOut, "#define rinbinom _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define rinbinomMu _rx%s%s%ld\n", extra, md5, __timeId++);
...
sAppend(&sbOut, "#define _llikNorm _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNormDmean _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNormDsd _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikPois _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikPoisDlambda _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikBinom _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikBinomDprob _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNbinom _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNbinomDprob _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNbinomMu _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikNbinomMuDmu _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikBeta _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikBetaDshape1 _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikBetaDshape2 _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikT _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikTDdf _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikTDmean _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikTDsd _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikChisq _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikChisqDdf _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikExp _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikExpDrate _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikF _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikFDdf1 _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikFDdf2 _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikGeom _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikGeomDp _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikUnif _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikUnifDalpha _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikUnifDbeta _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikWeibull _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikWeibullDshape _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikWeibullDscale _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikGamma _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikGammaDshape _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikGammaDrate _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikCauchy _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikCauchyDlocation _rx%s%s%ld\n", extra, md5, __timeId++);
sAppend(&sbOut, "#define _llikCauchyDscale _rx%s%s%ld\n", extra, md5, __timeId++);
...
sAppendN(&sbOut, "  rxnbinom = (rxode2i_rxbinom)R_GetCCallable(\"rxode2\",\"rxnbinom\");\n", 67);
sAppendN(&sbOut, "  rxnbinomMu = (rxode2i_rxbinom)R_GetCCallable(\"rxode2\",\"rxnbinomMu\");\n", 71);
...
sAppendN(&sbOut, "  rinbinom = (rxode2i2_ribinom)R_GetCCallable(\"rxode2\",\"rinbinom\");\n", 68);
sAppendN(&sbOut, "  rinbinomMu = (rxode2i2_ribinom)R_GetCCallable(\"rxode2\",\"rinbinomMu\");\n", 72);
...
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikNorm=(rxode2_llikNormFun) R_GetCCallable(\"rxode2\",\"rxLlikNorm\");\n", 72);
sAppendN(&sbOut, "  _llikNormDmean=(rxode2_llikNormFun) R_GetCCallable(\"rxode2\",\"rxLlikNormDmean\");\n", 82);
sAppendN(&sbOut, "  _llikNormDsd=(rxode2_llikNormFun) R_GetCCallable(\"rxode2\",\"rxLlikNormDsd\");\n", 78);
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikPois        = (rxode2_llikPoisFun) R_GetCCallable(\"rxode2\",\"rxLlikPois\");\n", 81);
sAppendN(&sbOut, "  _llikPoisDlambda = (rxode2_llikPoisFun) R_GetCCallable(\"rxode2\",\"rxLlikPoisDlambda\");\n", 88);
sAppendN(&sbOut, "  _llikBinom = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikBinom\");\n", 78);
sAppendN(&sbOut, "  _llikBinomDprob = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikBinomDprob\");\n", 88);
sAppendN(&sbOut, "  _llikNbinom = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikNbinom\");\n", 80);
sAppendN(&sbOut, "  _llikNbinomDprob = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikNbinomDprob\");\n", 90);
sAppendN(&sbOut, "  \n", 3);
sAppendN(&sbOut, "  _llikNbinomMu = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikNbinomMu\");\n", 84);
sAppendN(&sbOut, "  _llikNbinomMuDmu = (rxode2_llikBinomFun) R_GetCCallable(\"rxode2\", \"rxLlikNbinomMuDmu\");\n", 90);
sAppendN(&sbOut, "  _llikBeta = (rxode2_llikBetaFun)   R_GetCCallable(\"rxode2\", \"rxLlikBeta\");\n", 77);
sAppendN(&sbOut, "  _llikBetaDshape1 = (rxode2_llikBetaFun) R_GetCCallable(\"rxode2\", \"rxLlikBetaDshape1\");\n", 89);
sAppendN(&sbOut, "  _llikBetaDshape2 = (rxode2_llikBetaFun) R_GetCCallable(\"rxode2\", \"rxLlikBetaDshape2\");\n", 89);
sAppendN(&sbOut, "  _llikT = (rxode2_llikTFun)   R_GetCCallable(\"rxode2\", \"rxLlikT\");\n", 68);
sAppendN(&sbOut, "  _llikTDdf = (rxode2_llikTFun) R_GetCCallable(\"rxode2\", \"rxLlikTDdf\");\n", 72);
sAppendN(&sbOut, "  _llikTDmean = (rxode2_llikTFun) R_GetCCallable(\"rxode2\", \"rxLlikTDmean\");\n", 76);
sAppendN(&sbOut, "  _llikTDsd = (rxode2_llikTFun) R_GetCCallable(\"rxode2\", \"rxLlikTDsd\");\n", 72);
sAppendN(&sbOut, "  _llikChisq    = (rxode2_llikChisqFun) R_GetCCallable(\"rxode2\", \"rxLlikChisq\");\n", 81);
sAppendN(&sbOut, "  _llikChisqDdf = (rxode2_llikChisqFun) R_GetCCallable(\"rxode2\", \"rxLlikChisqDdf\");\n", 84);
sAppendN(&sbOut, "  _llikExp    = (rxode2_llikExpFun) R_GetCCallable(\"rxode2\", \"rxLlikExp\");\n", 75);
sAppendN(&sbOut, "  _llikExpDrate = (rxode2_llikExpFun) R_GetCCallable(\"rxode2\", \"rxLlikExpDrate\");\n", 82);
sAppendN(&sbOut, "  _llikF    = (rxode2_llikFFun) R_GetCCallable(\"rxode2\", \"rxLlikF\");\n", 69);
sAppendN(&sbOut, "  _llikFDdf1 = (rxode2_llikFFun) R_GetCCallable(\"rxode2\", \"rxLlikFDdf1\");\n", 74);
sAppendN(&sbOut, "  _llikFDdf2 = (rxode2_llikFFun) R_GetCCallable(\"rxode2\", \"rxLlikFDdf2\");\n", 74);
sAppendN(&sbOut, "  _llikGeom    = (rxode2_llikGeomFun) R_GetCCallable(\"rxode2\", \"rxLlikGeom\");\n", 78);
sAppendN(&sbOut, "  _llikGeomDp  = (rxode2_llikGeomFun) R_GetCCallable(\"rxode2\", \"rxLlikGeomDp\");\n", 80);
sAppendN(&sbOut, "  _llikUnif        = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2\", \"rxLlikUnif\");\n", 82);
sAppendN(&sbOut, "  _llikUnifDalpha  = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2\", \"rxLlikUnifDalpha\");\n", 88);
sAppendN(&sbOut, "  _llikUnifDbeta   = (rxode2_llikUnifFun) R_GetCCallable(\"rxode2\", \"rxLlikUnifDbeta\");\n", 87);
sAppendN(&sbOut, "  _llikWeibull        = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2\", \"rxLlikWeibull\");\n", 91);
sAppendN(&sbOut, "  _llikWeibullDshape  = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2\", \"rxLlikWeibullDshape\");\n", 97);
sAppendN(&sbOut, "  _llikWeibullDscale   = (rxode2_llikWeibullFun) R_GetCCallable(\"rxode2\", \"rxLlikWeibullDscale\");\n", 98);
sAppendN(&sbOut, "  _llikGamma        = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2\", \"rxLlikGamma\");\n", 85);
sAppendN(&sbOut, "  _llikGammaDshape  = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2\", \"rxLlikGammaDshape\");\n", 91);
sAppendN(&sbOut, "  _llikGammaDrate   = (rxode2_llikGammaFun) R_GetCCallable(\"rxode2\", \"rxLlikGammaDrate\");\n", 90);
sAppendN(&sbOut, "  _llikCauchy        = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2\", \"rxLlikCauchy\");\n", 88);
sAppendN(&sbOut, "  _llikCauchyDlocation  = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2\", \"rxLlikCauchyDlocation\");\n", 100);
sAppendN(&sbOut, "  _llikCauchyDscale   = (rxode2_llikCauchyFun) R_GetCCallable(\"rxode2\", \"rxLlikCauchyDscale\");\n", 95);
...
sAppendN(&sbOut, "#undef rxnbinom\n", 16);
sAppendN(&sbOut, "#undef rxnbinomMu\n", 18);
...
sAppendN(&sbOut, "#undef rinbinom\n", 16);
sAppendN(&sbOut, "#undef rinbinomMu\n", 18);
...
sAppendN(&sbOut, "#undef _llikNorm\n", 17);
sAppendN(&sbOut, "#undef _llikNormDmean\n", 22);
sAppendN(&sbOut, "#undef _llikNormDsd\n", 20);
sAppendN(&sbOut, "#undef _llikPois\n", 17);
sAppendN(&sbOut, "#undef _llikPoisDlambda\n", 24);
sAppendN(&sbOut, "#undef _llikBinom\n", 18);
sAppendN(&sbOut, "#undef _llikBinomDprob\n", 23);
sAppendN(&sbOut, "#undef _llikNbinom\n", 19);
sAppendN(&sbOut, "#undef _llikNbinomDprob\n", 24);
sAppendN(&sbOut, "#undef _llikNbinomMu\n", 21);
sAppendN(&sbOut, "#undef _llikNbinomMuDmu\n", 24);
sAppendN(&sbOut, "#undef _llikBeta\n", 17);
sAppendN(&sbOut, "#undef _llikBetaDshape1\n", 24);
sAppendN(&sbOut, "#undef _llikBetaDshape2\n", 24);
sAppendN(&sbOut, "#undef _llikT\n", 14);
sAppendN(&sbOut, "#undef _llikTDdf\n", 17);
sAppendN(&sbOut, "#undef _llikTDmean\n", 19);
sAppendN(&sbOut, "#undef _llikTDsd\n", 17);
sAppendN(&sbOut, "#undef _llikChisq\n", 18);
sAppendN(&sbOut, "#undef _llikChisqDdf\n", 21);
sAppendN(&sbOut, "#undef _llikExp\n", 16);
sAppendN(&sbOut, "#undef _llikExpDrate\n", 21);
sAppendN(&sbOut, "#undef _llikF\n", 14);
sAppendN(&sbOut, "#undef _llikFDdf1\n", 18);
sAppendN(&sbOut, "#undef _llikFDdf2\n", 18);
sAppendN(&sbOut, "#undef _llikGeom\n", 17);
sAppendN(&sbOut, "#undef _llikGeomDp\n", 19);
sAppendN(&sbOut, "#undef _llikUnif\n", 17);
sAppendN(&sbOut, "#undef _llikUnifDalpha\n", 23);
sAppendN(&sbOut, "#undef _llikUnifDbeta\n", 22);
sAppendN(&sbOut, "#undef _llikWeibull\n", 20);
sAppendN(&sbOut, "#undef _llikWeibullDshape\n", 26);
sAppendN(&sbOut, "#undef _llikWeibullDscale\n", 26);
sAppendN(&sbOut, "#undef _llikGamma\n", 18);
sAppendN(&sbOut, "#undef _llikGammaDshape\n", 24);
sAppendN(&sbOut, "#undef _llikGammaDrate\n", 23);
sAppendN(&sbOut, "#undef _llikCauchy\n", 19);
sAppendN(&sbOut, "#undef _llikCauchyDlocation\n", 28);
sAppendN(&sbOut, "#undef _llikCauchyDscale\n", 25);
